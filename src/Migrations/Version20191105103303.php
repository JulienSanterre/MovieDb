 ...
 */
final class Version20191105103303 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team ADD movie_id INT NOT NULL, ADD person_id INT DEFAULT NULL, ADD job_id INT DEFAULT NULL');
