 ...
 */
final class Version20191122231100 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE casting DROP api_person_id_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE casting ADD api_person_id_id INT DEFAULT NULL');
